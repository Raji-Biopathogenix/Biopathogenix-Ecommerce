...
# Always load environment variables from backend/.env, regardless of where
# manage.py is executed from.
...
#
# Prefer SQLite for local development so the project starts cleanly without a
# database server. Set DB_ENGINE=mysql in the environment when you want MySQL.
