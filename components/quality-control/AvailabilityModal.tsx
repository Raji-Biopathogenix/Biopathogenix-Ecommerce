...
import AvailabilityForm from "@/components/quality-control/AvailabilityForm";
...
export default function AvailabilityModal({ isOpen, onClose }: AvailabilityModalProps) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Confirm availability form"
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        <div className="relative max-h-[calc(100vh-7.5rem)] overflow-y-auto p-4 md:p-6">
          ...
          <AvailabilityForm inModal onSubmitted={onClose} showHeading />
        </div>
      </div>
    </div>
  );
